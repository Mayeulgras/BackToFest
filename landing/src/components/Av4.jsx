    ...
    return (
        <div style={{display: 'flex', alignItems: 'center', marginTop: '50px'}}>
            ...
            <div style={{marginLeft: '20px'}}>
                <p style={{fontSize: '1.5em', marginRight: '3%'}}>Comment cela fonctionne ? Nous vous passons nos stocks de gobelets et barquettes réutilisables que vous vendrez dans
